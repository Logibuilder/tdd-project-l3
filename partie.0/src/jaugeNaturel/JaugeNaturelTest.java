...
public class JaugeNaturelTest {
	...
	public void initialiser() throws Exception {
		...
		jauge2 = new JaugeNaturel(4,50, 6);
		jauge3 = new JaugeNaturel(30, 350, 15);
		jauge4 = new JaugeNaturel(-68, 150, -68);
		jauge5 = new JaugeNaturel(15, 567, 733);
		jauge6 = new JaugeNaturel(56, 300, 300);
