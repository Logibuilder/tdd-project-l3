 ...
 * </p>
 */
public class JaugeReelTest implements IJaugeTest{
	/**
	 * Cette méthode crée une nouvelle instance de JaugeReel avec les paramètres spécifiés pour les tests.
	 *
	 */
	public JaugeReel creerJauge(long min, long max, long depart) {
		return new JaugeReel(min, max, depart);
		
	}
	JaugeReel jauge1, jauge2, jauge3, jauge4, jauge5, jauge6, jauge7, jauge8, jauge9;
	...
	public void testToString() { 
		String res_attendu = String.format("<%.3f [%.3f,%.3f]>", 100 / 1000.0, -345 / 1000.0, 67899 / 1000.0);
