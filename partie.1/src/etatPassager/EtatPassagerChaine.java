...
public class EtatPassagerChaine implements IEtatPassager{
  /**
   * Définit les trois états possible d'un passager dans un transport en ch=aine de caractère686.
   */
	public static String ASSIS="Assis"; 
    public static String DEBOUT="Debout";
    public static String DEHORS="Dehors";

    private final String monEtat;

  /**
   * Construit une instance en précisant l'état du passager en chaine66.
   * 
